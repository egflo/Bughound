...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Edit Severity Details</title>
	...
	<body style="background-color: #E5E7E9;">
        <h1>Edit Severity Details</h1>
        <form action="update_severity.php" method="post" onsubmit="return validate(this)">
        <?php
			//Connect to Database
			...
			$query = "SELECT * FROM severity WHERE id = $id";
