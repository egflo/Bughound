...
<html>
	...
	<body style="background-color: #E5E7E9;">
        <h1>Add Severity Type</h1>
        <form action="add_severity.php" method="post" onsubmit="return validate(this)">
            <table>
                <tr><td>Severity Description:</td><td><input type="Text" name="desc"</td></tr>
